  ...
  zh: {
    ...
    home: {
      ...
      management: {
        ...
        description: '发送截图之后，真正重要的是两件事：自动清掉不需要的内容，以及保留你想再次找到的内容。',
      ...
      pricingPreview: {
        ...
        monthly: { title: 'Monthly', price: '$2.99', period: '/month', description: '灵活计费' },
        annual: { title: 'Annual', price: '$17.99', period: '/year', description: '最划算', badge: '省 50%' },
        lifetime: { title: 'Lifetime', price: '$24.99', period: '', description: '买一次，永久拥有' },
        cta: '前往 App Store',
    ...
    pricingPage: {
      ...
      proNote: '提供 Monthly、Yearly 和 Lifetime 方案',
      ...
      plans: [
        { name: 'Monthly', subtitle: '按需付费', price: '$2.99', period: '/month' },
        { name: 'Yearly', subtitle: '最划算', price: '$17.99', period: '/year', perMonth: '$1.50/month', popular: true },
        { name: 'Lifetime', subtitle: '无需订阅', price: '$24.99', paidOnce: '一次付费' },
      ],
      getProCta: '获取 Pro',
      ...
      reasons: [
        ...
        {
          title: '选择适合你的方案',
          description: 'Monthly 更灵活，Yearly 最划算，Lifetime 则是一次性投入。',
        },
        {
          title: '同样优秀的工作流',
